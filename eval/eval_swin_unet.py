"""Evaluate the pretrained Swin-UNet checkpoint on data/raw/test."""
...
def save_results_txt(save_path, test_loss, pixel_acc, miou, class_iou):
    with open(save_path, "w", encoding="utf-8") as f:
        f.write("Pretrained Swin-UNet Test Results\n")
        f.write("=" * 60 + "\n")
...
def main():
    ...
    print(f"Epoch: {checkpoint.get('epoch')}  Eval mIoU: {checkpoint.get('miou')}")
