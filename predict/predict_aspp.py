...
def main():
    ...
    print("=" * 80)
    print("U-Net + ASPP Prediction (Ablation)")
    print("=" * 80)
    ...
    checkpoint_path = PROJECT_ROOT / "outputs" / "checkpoints" / "unet_aspp_best.pth"
    save_dir = PROJECT_ROOT / "outputs" / "predictions" / "unet_aspp"
